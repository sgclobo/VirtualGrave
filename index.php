...
<section class="hero-section">
  ...
  <div class="hero-content">
    ...
    <div class="hero-portrait-wrap">
      ...
      <!-- If portrait photo exists: -->
      <!-- <img src="<?= SITE_URL ?>/uploads/portrait.jpg" class="hero-portrait" alt="<?= e($deceasedName) ?>"> -->
    </div>
...
<section class="stats-bar">
  <div class="container-memorial">
    <div class="stats-grid">
      ...
      <div class="stat-item">
        <span class="stat-icon">👥</span>
        <span class="stat-number" data-count="<?= $stats['visitors'] ?>"><?= number_format($stats['visitors']) ?></span>
...
<section class="grave-section">
  ...
  <div class="container-memorial w-100">
    <div class="grave-scene">
      ...
      <h2 class="font-display reveal" style="color:var(--ivory);font-size:clamp(1.6rem,3vw,2.5rem);font-weight:300;margin-bottom:2.5rem;">
      ...
      <div class="grave-flowers" id="graveFlowersArea">
        ...
        <span style="color:rgba(250,248,243,0.2);font-style:italic;font-size:0.85rem;">Be the first to leave flowers…</span>
        <?php endif; ?>
      </div>
      ...
      <div class="grave-candles" id="graveCandlesArea">
        ...
        <span style="color:rgba(250,248,243,0.2);font-style:italic;font-size:0.85rem;">Light the first candle…</span>
        <?php endif; ?>
      </div>
  ...
  <div class="container-memorial">
    ...
    <div class="row g-4 text-center">
      ...
      <div class="col-6 col-md-3 reveal reveal-delay-<?= $i+1 ?>">
        <a href="<?= SITE_URL ?>/pages/<?= $page ?>" class="d-block text-decoration-none hover-lift" style="color:inherit;">
          <div style="width:70px;height:70px;border-radius:50%;background:rgba(201,168,76,0.1);border:1px solid rgba(201,168,76,0.2);display:flex;align-items:center;justify-content:center;margin:0 auto 1rem;font-size:1.6rem;color:var(--soft-gold);transition:all 0.3s ease;">
            <i class="bi <?= $icon ?>"></i>
          </div>
          <h3 class="font-display" style="font-size:1.3rem;font-weight:300;color:var(--ivory);margin-bottom:0.5rem;"><?= $label ?></h3>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="text-muted-memorial mb-3 font-display fst-italic">Choose a flower to place with love at the memorial…</p>
...
<div class="modal fade memorial-modal" id="candleModal" tabindex="-1" aria-label="Light a Candle">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="text-muted-memorial mb-3 font-display fst-italic">Choose a candle and dedicate it in loving memory…</p>
          ...
          <div class="row g-3 mb-4">
            ...
            <div class="col-6 col-md-3">
              <div class="candle-option" data-id="<?= $c['id'] ?>">
                ...
                <div class="candle-option-body mx-auto mb-2" style="box-shadow: 0 0 8px <?= e($c['glow_color']) ?>60;"></div>
