...
<head>
  ...
  <meta name="description" content="A sacred digital memorial for <?= e($deceasedName) ?>. Light candles, leave flowers, share memories and prayers.">
  ...
  <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,600;1,300;1,400&family=Crimson+Pro:ital,wght@0,300;0,400;1,300&family=EB+Garamond:ital,wght@0,400;0,500;1,400&display=swap" rel="stylesheet">
...
<nav class="memorial-nav" id="mainNav">
  <div class="nav-inner">
    ...
    <div class="nav-links" id="navLinks">
      ...
      <a href="<?= SITE_URL ?>/pages/biography.php" class="nav-link <?= ($activePage??'')==='bio'?'active':'' ?>">
        <i class="bi bi-book"></i> Biography
      </a>
      <a href="<?= SITE_URL ?>/pages/gallery.php" class="nav-link <?= ($activePage??'')==='gallery'?'active':'' ?>">
        <i class="bi bi-images"></i> Gallery
      </a>
      <a href="<?= SITE_URL ?>/pages/timeline.php" class="nav-link <?= ($activePage??'')==='timeline'?'active':'' ?>">
        <i class="bi bi-clock-history"></i> Timeline
      </a>
      <a href="<?= SITE_URL ?>/pages/memorial.php" class="nav-link <?= ($activePage??'')==='memorial'?'active':'' ?>">
